...
import { DOMInterface } from '../../src/framework/vm';
...
interface DOMDOMInterface extends DOMInterface {
    Node: Node;
    Element: Element;
}
...
export const renderer: Renderer<DOMDOMInterface> = {
    ...
    insert(node: Node, parent: Element, anchor: Node): void {
